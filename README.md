...
página de Facebook y tu cuenta de Instagram, generando la descripción con IA
(API de Anthropic) y sin repetir imágenes ya usadas.
...
3. Si ya pasaron 20hs, elige una imagen de `images/` que no esté en
   `used_images`, le pide a Claude (con visión) que escriba una descripción
   corta, y publica en Facebook e Instagram.
...
Creá una key en https://console.anthropic.com (sección API Keys).
